...
fluidAngle = uiknob(speedPanel, ...
    ...
    'Value', 180, ...
    'Limits', [0, 360]);
uilabel(speedPanel, 'Text', 'Viskozita', ...
...
clearButton = uibutton(controlPanel, 'Text', 'Vyčistit', ...
